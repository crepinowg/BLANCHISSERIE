 ...
 */
final class Version20230729135736 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE administrateur (id INT AUTO_INCREMENT NOT NULL, roles JSON NOT NULL, suspendu TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE cle_produit (id INT AUTO_INCREMENT NOT NULL, administrateur_id INT DEFAULT NULL, super_admin_id INT DEFAULT NULL, cle VARCHAR(255) NOT NULL, duree INT NOT NULL, statut TINYINT(1) NOT NULL, created_at VARCHAR(255) NOT NULL, etat TINYINT(1) NOT NULL, duree_reste INT NOT NULL, prix INT NOT NULL, use_at VARCHAR(255) DEFAULT NULL, INDEX IDX_4751B3F37EE5403C (administrateur_id), INDEX IDX_4751B3F3BBF91D3B (super_admin_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE client (id INT AUTO_INCREMENT NOT NULL, gerant_id INT DEFAULT NULL, administrateur_id INT DEFAULT NULL, zip VARCHAR(255) NOT NULL, indication VARCHAR(255) NOT NULL, roles JSON NOT NULL, statut VARCHAR(255) NOT NULL, code_ui VARCHAR(255) NOT NULL, deleted TINYINT(1) DEFAULT NULL, INDEX IDX_C7440455A500A924 (gerant_id), INDEX IDX_C74404557EE5403C (administrateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE depense (id INT AUTO_INCREMENT NOT NULL, admin_id INT DEFAULT NULL, gerant_id INT DEFAULT NULL, type_depense INT NOT NULL, nom_produit VARCHAR(60) NOT NULL, description VARCHAR(255) NOT NULL, prix_total INT NOT NULL, calcul_depense TINYINT(1) NOT NULL, created_at VARCHAR(60) NOT NULL, deleted TINYINT(1) DEFAULT NULL, INDEX IDX_34059757642B8210 (admin_id), INDEX IDX_34059757A500A924 (gerant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE employe (id INT AUTO_INCREMENT NOT NULL, administrateur_id INT NOT NULL, gerant_id INT DEFAULT NULL, avatar VARCHAR(60) DEFAULT NULL, salaire INT NOT NULL, anne_experience INT DEFAULT NULL, type_paiement TINYINT(1) DEFAULT NULL, roles JSON NOT NULL, code_ui VARCHAR(255) NOT NULL, statut TINYINT(1) DEFAULT NULL, INDEX IDX_F804D3B97EE5403C (administrateur_id), INDEX IDX_F804D3B9A500A924 (gerant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE entete (id INT AUTO_INCREMENT NOT NULL, facture_id INT DEFAULT NULL, tarifs_id INT NOT NULL, quantite INT NOT NULL, prix_total INT NOT NULL, express TINYINT(1) NOT NULL, date_delivered_express VARCHAR(255) DEFAULT NULL, express_delivered TINYINT(1) DEFAULT NULL, statut TINYINT(1) DEFAULT NULL, INDEX IDX_1333E1437F2DEE08 (facture_id), INDEX IDX_1333E143F5F3287F (tarifs_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE entreprise (id INT AUTO_INCREMENT NOT NULL, administrateur_id INT NOT NULL, numero_tel_entre INT NOT NULL, email_entre VARCHAR(255) NOT NULL, numero_entreprise_check TINYINT(1) DEFAULT NULL, email_entreprise_check TINYINT(1) NOT NULL, nom VARCHAR(60) NOT NULL, adresse VARCHAR(255) NOT NULL, zip VARCHAR(255) DEFAULT NULL, INDEX IDX_D19FA607EE5403C (administrateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE equipe (id INT AUTO_INCREMENT NOT NULL, administrateur_id INT DEFAULT NULL, gerant_id INT DEFAULT NULL, nom VARCHAR(60) NOT NULL, avatar VARCHAR(60) DEFAULT NULL, created_at VARCHAR(60) NOT NULL, description VARCHAR(255) DEFAULT NULL, code_ui VARCHAR(255) NOT NULL, statut TINYINT(1) DEFAULT NULL, INDEX IDX_2449BA157EE5403C (administrateur_id), INDEX IDX_2449BA15A500A924 (gerant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE facture (id INT AUTO_INCREMENT NOT NULL, admin_id INT DEFAULT NULL, client_id INT NOT NULL, livraison_id INT DEFAULT NULL, gerant_id INT DEFAULT NULL, total_ttc INT NOT NULL, total_tva INT NOT NULL, taux_reduction DOUBLE PRECISION DEFAULT NULL, date_livraison VARCHAR(255) NOT NULL, num_facture INT DEFAULT NULL, etat VARCHAR(255) DEFAULT NULL, facture_id_number VARCHAR(255) NOT NULL, express TINYINT(1) NOT NULL, delivered_at VARCHAR(255) DEFAULT NULL, date_recuperation VARCHAR(255) NOT NULL, invoice_code VARCHAR(255) NOT NULL, jours_passer INT DEFAULT NULL, heure_passer INT DEFAULT NULL, INDEX IDX_FE866410642B8210 (admin_id), INDEX IDX_FE86641019EB6921 (client_id), INDEX IDX_FE8664108E54FB25 (livraison_id), INDEX IDX_FE866410A500A924 (gerant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE gerant (id INT AUTO_INCREMENT NOT NULL, roles JSON NOT NULL, code_ui VARCHAR(255) NOT NULL, salaire INT NOT NULL, statut TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, gerant_id INT DEFAULT NULL, administrateur_id INT DEFAULT NULL, employe_id INT DEFAULT NULL, created_by_gerant_id INT DEFAULT NULL, created_by_admin_id INT DEFAULT NULL, super_admin_id INT DEFAULT NULL, photo_profile VARCHAR(255) DEFAULT NULL, nom VARCHAR(30) NOT NULL, numero INT NOT NULL, email VARCHAR(60) DEFAULT NULL, email_check TINYINT(1) NOT NULL, numero_check TINYINT(1) NOT NULL, mot_de_passe VARCHAR(255) NOT NULL, username VARCHAR(30) NOT NULL, created_at VARCHAR(30) NOT NULL, roles JSON NOT NULL, adresse VARCHAR(255) NOT NULL, etat_suspendu TINYINT(1) DEFAULT NULL, sexe VARCHAR(60) DEFAULT NULL, INDEX IDX_1D1C63B319EB6921 (client_id), INDEX IDX_1D1C63B3A500A924 (gerant_id), INDEX IDX_1D1C63B37EE5403C (administrateur_id), INDEX IDX_1D1C63B31B65292 (employe_id), INDEX IDX_1D1C63B3FF05AC49 (created_by_gerant_id), INDEX IDX_1D1C63B364F1F4EE (created_by_admin_id), INDEX IDX_1D1C63B3BBF91D3B (super_admin_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE cle_produit');
